...
![Ren'Py公式チュートリアルに導入したRen'Py Debug UI](/images/posts/programming/renpy-debug-ui/renpy-debug-ui-01.jpg)
...
![Ren'Py Debug UIの言語切り替え画面](/images/posts/programming/renpy-debug-ui/renpy-debug-ui-02.png)
...
![Ren'Py Debug UIのセリフ位置表示](/images/posts/programming/renpy-debug-ui/renpy-debug-ui-03.png)
...
![Ren'Py Debug UIのゲーム情報表示](/images/posts/programming/renpy-debug-ui/renpy-debug-ui-04.png)
...
![Ren'Py Debug UIのStore Explorer](/images/posts/programming/renpy-debug-ui/renpy-debug-ui-05.png)

Ren'Pyのstore変数に登録されている値を直接参照したり、編集することができます

編集の際は、以下のようなボックスから編集が可能です

![Ren'Py Debug UIの変数編集画面](/images/posts/programming/renpy-debug-ui/renpy-debug-ui-06.jpg)
...
![GitHubのDownload ZIPボタン](/images/posts/programming/renpy-debug-ui/renpy-debug-ui-07.png)
