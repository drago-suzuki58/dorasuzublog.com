...
![Stackerのサムネイル](/images/posts/games/minecraft/stacker/stacker-01.png)
...
配布は[CurseForge](https://www.curseforge.com/minecraft/mc-mods/stacker)から
...
ただ、比較的古い2つの **1.15.2 1.16.5** バージョンに関しては、このStacker MODの前身となる **[stacc MOD](https://www.curseforge.com/minecraft/mc-mods/stacc)** をダウンロードしなければなりません。

しかし、MODの内容的にはどちらも同じですので、そこまで気にする必要はないかと思います。

まあ、操作性だったり設定方法だったりは異なると思いますが…

そして、Forgeバージョンの方は、名前が少々異なっていて、 **[bigger stacks](https://www.curseforge.com/minecraft/mc-mods/bigger-stacks)** という名前ですが、 **1.12.2 1.13.x 1.18.2 1.19.x** で対応していて、

こちらも先ほどと同じく、古い2つの **1.12.2 1.13.x** バージョンに関しては、 **[stack up MOD](https://www.curseforge.com/minecraft/mc-mods/stackup)** をダウンロードする必要があります。
...
![Stackerの設定画面](/images/posts/games/minecraft/stacker/stacker-02.png)

[CurseForgeのStackerページ](https://www.curseforge.com/minecraft/mc-mods/stacker)より引用
...
![bigger stacksの初期設定メッセージ](/images/posts/games/minecraft/stacker/stacker-03.png)

[CurseForgeのbigger stacksページ](https://www.curseforge.com/minecraft/mc-mods/bigger-stacks)より引用

![bigger stacksのスタック数設定画面](/images/posts/games/minecraft/stacker/stacker-04.jpg)
...
![stackup.cfgのmaxStackSize設定](/images/posts/games/minecraft/stacker/stacker-05.png)
